...
<body style=" margin:0;">
    ...
    <div class = "dashboard">
        <h1 class="account">Restaurant</h1>
        <nav>
            <a style="text-decoration: none;" href="AddRestaurant.php">Add Restaurant</a>
            <a style="text-decoration: none;" href="ViewRestaurant.php">View Restaurant</a>
            <a style="text-decoration: none;" href="EditRestaurant.php">Edit Restaurant</a>
            <a style="text-decoration: none;" href="Dashboard.php">Go to Dashboard</a>
        </nav>
    </div>
